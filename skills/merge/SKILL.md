...
- Landing approved PRs on main (see "Merge to Main" section below)
...
1. **Subtask completes work** and ensures all commits are clean
...
4. **Coordinator reviews** the subtask's changes
...
5. Never force-push main. Never merge PRs that haven't passed CI. If conflicts exist, resolve in a separate branch first.
