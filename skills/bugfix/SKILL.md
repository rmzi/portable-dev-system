...
- If the cause is unknown, write your hypothesis first (what you think is happening, evidence that would confirm/disprove), then investigate.
...
- Commit with `fix(scope): description` format (conventional commits)
