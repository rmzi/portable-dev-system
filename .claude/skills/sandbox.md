...
| **4. Agent prompts** | Constraints in `.claude/agents/*.md` | Role-specific behavior (read-only, stay in worktree) |
...
- `/audit-config` — Verify sandbox is properly configured
- `/team` — Agent roles and permission modes
